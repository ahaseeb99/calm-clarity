...
<head>
    ...
    <meta name="author" content="Abdul Haseeb Q. a.k.a twistyBRAT 鬼 ];)">
    <meta name="description" content="Yo! Just a devious boring typical guy skilled Front End Development | Web Development & Design | HTML & CSS | SASS | Bootstrap | JavaScript | WordPress Development | Googling | Tech Enthusiast | Learning Enthusiast &  likes Anime + Manga + Comics + Gaming + Weird things and a lot of Music 🙀👽">
    <meta name="description" content="https://probdone.com | https://www.linkedin.com/in/abdul-haseeb-qamar | a.haseeb199@gmail.com">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Red+Hat+Display:ital,wght@0,300..900;1,300..900&family=Red+Hat+Text:ital,wght@0,300..700;1,300..700&family=Redacted+Script:wght@300;400;700&display=swap" rel="stylesheet">
                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="navbar-collapse">
                                    <ul id="nav" class="navbar-nav mx-auto">
                                        ...
                                        <?php } ?>
                                        <li class="nav-item">
                                            <a class="ud-menu-scroll" href="#features"><?php _e("Contact") ?></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="navbar-btn d-flex align-items-center">
                                                ...
                                                <ul class="user-menu-small-nav">
                                                    ...
                                                    if ($config['enable_ai_chat']) {
                                                        if (!get_option('hide_plan_disabled_features') || (get_option('hide_plan_disabled_features') && $plan_settings['ai_chat'])) { ?>
                                                            <li><a href="<?php url("AI_CHAT_BOTS") ?>"><i class="icon-feather-message-circle"></i> <?php _e("AI Chat") ?>
                                                                </a></li>
                                                        <?php }
                                                    }
                                                    if ($config['enable_speech_to_text']) {
                                                        if (!get_option('hide_plan_disabled_features') || (get_option('hide_plan_disabled_features') && $plan_settings['ai_speech_to_text_limit'])) { ?>
                                                            <li><a href="<?php url("AI_SPEECH_TEXT") ?>"><i class="icon-feather-headphones"></i> <?php _e("Speech to Text") ?>
                                                                </a></li>
                                                        <?php }
                                                    }
                                                    if (get_option('enable_text_to_speech', 0)) {
                                                        if (!get_option('hide_plan_disabled_features') || (get_option('hide_plan_disabled_features') && $plan_settings['ai_text_to_speech_limit'])) { ?>
                                                            <li><a href="<?php url("AI_TEXT_SPEECH") ?>"><i class="icon-feather-volume-2"></i> <?php _e("Text to Speech") ?>
                                                                </a></li>
                                                        <?php }
                                                    }
                                                    if ($config['enable_ai_code']) {
                                                        if (!get_option('hide_plan_disabled_features') || (get_option('hide_plan_disabled_features') && $plan_settings['ai_code'])) { ?>
                                                            <li><a href="<?php url("AI_CODE") ?>"><i class="icon-feather-code"></i> <?php _e("AI Code") ?>
                                                                </a>
                                                            </li>
                                                    <?php }
                                                    } ?>
                                    ...
                                    <?php } else { ?>
                                        <a href="#sign-in-dialog" class="popup-with-zoom-anim ud-main-btn ud-white-btn ripple-effect">
                                            <span><?php _e("Sign In") ?>&nbsp;</span><i class="icon-feather-log-in"></i>
                                        </a>
                                    <?php } ?>
